...
const Hero = () => {
  return (
    <div className="relative px-10 flex flex-col md:flex-row justify-center md:justify-around items-center h-[calc(100vh-204px)] overflow-hidden">

      {/* Overlay */}
      <div className="absolute inset-0 via-transparent to-transparent pointer-events-none" />

      {/* Text Block */}
      <div className=" w-full md:w-150 text-center md:text-left mb-8 md:mb-0">
